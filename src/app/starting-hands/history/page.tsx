...
export default function StartingHandsHistoryPage() {
    ...
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-10 px-4 py-10">
      <div>
        ...
        <p className="mt-2 text-sm text-stone-600 dark:text-stone-400">
          Past rounds (newest first). Up to 10 stored locally.
        </p>
      </div>

      <QuizHistoryView history={progress.startingHands.quizHistory} />
    </main>
  );
}
