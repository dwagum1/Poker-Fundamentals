...
export default function ImpliedOddsHubPage() {
  return (
    <>
      <HubTracker />
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-4 py-10">
        <div>
          ...
          <p className="mt-2 text-stone-600 dark:text-stone-400">
            Money you might win on later streets when you hit—not only the pot
            right now. Builds on pot odds and break-even equity.
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          <Link
            href="/implied-odds/learn"
          ...
          >
            ...
            <p className="mt-2 text-sm text-stone-600 dark:text-stone-400">
              Definition vs immediate pot odds, when implied odds matter, caveats,
              reverse implied odds, and a round-number snapshot example.
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="mt-2 text-sm text-stone-600 dark:text-stone-400">
              Ten mixed questions: concepts plus integer break-even % with implied
              extra pot.
            </p>
          </Link>
        </div>
