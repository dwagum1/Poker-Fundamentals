...
export default function RangesTextureHubPage() {
  return (
    <>
      <HubTracker />
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-4 py-10">
        <div>
          ...
          <p className="mt-2 text-stone-600 dark:text-stone-400">
            Think in hand groups, read coarse flop textures, and connect boards
            to who likely benefits—fundamentals only, no solver charts.
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          <Link
            href="/ranges-and-texture/learn"
          ...
          >
            ...
            <p className="mt-2 text-sm text-stone-600 dark:text-stone-400">
              Ranges, position, dry/wet boards, and how runouts fit different
              stories.
            </p>
          </Link>
          <Link
