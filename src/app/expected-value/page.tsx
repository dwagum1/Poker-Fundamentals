...
export default function ExpectedValueHubPage() {
  return (
    <>
      <HubTracker />
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-4 py-10">
        <div>
          ...
          <p className="mt-2 text-stone-600 dark:text-stone-400">
            Long-run profit from decisions: EV of calling, pure bluffs, and how
            this ties to pot odds and implied odds.
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          <Link
            href="/expected-value/learn"
          ...
          >
            ...
            <p className="mt-2 text-sm text-stone-600 dark:text-stone-400">
              What EV means, simple EV of a call, and a pure-bluff snapshot.
            </p>
          </Link>
          <Link
            href="/expected-value/quiz"
            className="rounded-2xl border border-stone-200 bg-[var(--card)] p-6 shadow-sm transition hover:border-emerald-400 dark:border-stone-800 dark:bg-stone-900/60 dark:hover:border-emerald-600"
          >
            <h2 className="text-lg font-semibold text-stone-900 dark:text-stone-50">
              Quiz
